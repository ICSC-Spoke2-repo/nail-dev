...
flow = SampleProcessing("flowTest", 'dictionaries/nanoAOD_PHYSLITE_id.json')
...
flow.Define("Muon_pt_GeV",   "Muon_pt*0.001f")


flow.Define("Muon_p4",  "vector_map_t<ROOT::Math::LorentzVector<ROOT::Math::PtEtaPhiM4D<float> > >(Muon_pt_GeV , Muon_eta, Muon_phi, Muon_m)")
flow.Define("Muon_iso", "Muon_pfRelIso04_all")


#flow.SubCollection("SelectedMuon", "Muon", sel="Muon_iso < 0.25 && Muon_tightId && Muon_pt_GeV > 20. && abs(Muon_eta) < 2.4")
flow.SubCollection("SelectedMuon", "Muon", sel="Muon_iso < 0.25 && Muon_pt_GeV > 20. && abs(Muon_eta) < 2.4")
...
flow.DefineHisto1D("LeadMuon_pt_GeV",  ['etaLeadMuonPos'], 100, 0.0, 1000.0)
flow.DefineHisto1D("LeadMuon_pt_GeV",  ['etaLeadMuonNeg'], 100, 0.0, 1000.0)
...
targetList = ["HISTO_nSelectedMuon",
              "HISTO_Dimuon_m__twoOppositeSignMuons",
              "HISTO_LeadMuon_pt_GeV__etaLeadMuonPos",
              "HISTO_LeadMuon_pt_GeV__etaLeadMuonNeg",
              "HISTO_LeadMuon_eta__etaLeadMuonPos",
              "HISTO_LeadMuon_eta__etaLeadMuonNeg"]
...
flow.saveFlowToFile("flow_OpenData_ATLAS.json")


print("[build_flow] end")
